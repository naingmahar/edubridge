...
import { Header, Label, LgLabel, PLabel } from "../../atoms/typography/typography"
...
export const LoadingHeader = (props:IProps) => {
    if(props.isLoading){
        return (
            <ColumnContainer className="flex-none items-center py-1 px-0">
    ...
    if(props.isSuccess){
        return (
            <ColumnContainer className="items-center py-1 flex-none">
                <ColumnContainer className="py-3 items-center flex-none">
                ...
                <PLabel className="mb-5">{props.successDescription || ""}</PLabel>
            </ColumnContainer>
        )
    }
